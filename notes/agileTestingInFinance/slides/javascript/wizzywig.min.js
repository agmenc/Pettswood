...
WizzyWig.console='<div class="middleFixed"><div id="wizzywigConsole" class="console tablet"><span id="plus">w</span><div class="left spaced" style="margin-top: 20px; ">'+WizzyWig.saveButton+WizzyWig.helpButton+'</div><div class="left">'+WizzyWig.simpleConcept1+WizzyWig.simpleConcept2+"</div>"+WizzyWig.multiRowConcept+WizzyWig.clearDiv+"</div></div>";WizzyWig.knownBugs="These features are known to misbehave in certain browsers:\n * Input fields don't respond to mouse clicks (Firefox)\n * Failure to insert the correct cells when adding columns (IE8)\n";
